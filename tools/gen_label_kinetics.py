...
dataset_path = '/home/lishuang/Disk/gitlab/Anti-tail/video_train'
label_path = '/home/lishuang/Disk/gitlab/Anti-tail/video_label'

if __name__ == '__main__':
    with open('anti_tail_label_map.txt') as f:
    ...
    files_input = ['kinetics_val_3c.csv', 'kinetics_train_3c.csv']
